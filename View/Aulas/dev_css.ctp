    ...
    margin-left: 20px;
     ...
     <div class="step-pane" id="step6">
        ...
        <p>
            ...
            com o código acima clicando em "Edit on Codepen",
            <a href="#codePenModal" role="button"  data-toggle="modal">
              veja aqui uma demonstração.
            </a>
          </p>
          
          <pre class="codepen" data-height="360" data-type="result" data-href="koJhu" data-user="anarute" data-safe="true">
            <code></code><a href="http://codepen.io/anarute/pen/koJhu">Check out this Pen!</a></pre>
...
<div id="codePenModal" class="modal hide fade"  tabindex="-1" 
  ...
  <div class="modal-body">
    <div class="row-fluid">
      <div class="flowplayer span12">
                <?php echo $this->Html->media(array(
                      array('src' => 'codepen_introducao_legenda.webm', 
                            'type' => "video/webm"),
                      array('src' => 'http://localhost/curso/files/codepen_introducao_legenda.mp4', 
                            'type' => "video/mp4"),
                                                   ),
                      array()); 
                ?>
