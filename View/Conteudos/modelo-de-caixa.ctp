...
<div class="container unique-content">
    ...
    <div class="step-content">
        <div class="step-pane in" id="modelo-caixa">
            ...
            <p>
                Todo elemento HTML tem o formato de uma caixa, mesmo que não 
                seja visível ao usuário. Por isso, é possível atribuir a 
                todo elemento propriedades como 
                <a href="http://escola.mupi.me/conteudos/css-width-height"
                    target="blank">altura e largura</a>. 
            </p>
            <p>
                Considerando ainda este modelo, seguem outras propriedades CSS
                 referentes a ele:
            </p>
        
            <div class="row-fluid box-example">
                <div id="box-margin" 
                    title="Margin é o espaço que me distancia dos 
                                outros elementos" class="span6">
                    margin
                    <div id="box-border" title="Esta é minha borda">
                        border
                        <div id="box-padding" 
                            title="Padding serve para distanciar o conteúdo 
                                dos limites do elemento">
                            padding
                            <div id="box-conteudo" 
                                title="É tudo que está dentro das tags de qualquer elemento">
            ...
            <div id="box-explanation" class="span6">
                <div id="exp-box" class="explanation hide">
                    Passe o mouse no modelo ao lado para entender o que é 
                    cada propriedade.
                </div>
                <div id="exp-box-margin" class="explanation">
                    A propriedade <code>margin</code> (que traduzida significa
                    margem) é o espaço que fica entre o elemento e os que estão 
                    ao seu redor.
                </div>
                <div id="exp-box-border" class="explanation">
                    A propriedade <code>border</code>, como o próprio nome 
                    diz, é a borda do elemento e ela pode receber diferentes 
                    tipos de estilo.
                </div>
                <div id="exp-box-padding" class="explanation">
                    A propriedade <code>padding</code> serve para definir o 
                    espaço <strong>interno</strong> que fica entre a borda e 
                    o conteúdo do elemento.
                </div>
                <div id="exp-box-conteudo" class="explanation">
                    E, para lembrar, o conteúdo é tudo que fica dentro das 
            ...
            <p>
                ...
                propriedades <code>margin</code> e 
                <code>padding</code> são muito importantes para o visual da 
                página. Elas dão o que podemos chamar de "respiro" ao 
                conteúdo da página. Elas são os espaços entre, por exemplo,
                textos, imagens e seções, fazendo muita diferença para o 
                usuário se sentir confortável ao navegar num site ou ler 
                um texto.
            </p>
            <h3>Declarando margin e padding</h3>
            <p> 
                Seguindo a analogia da caixa, temos 4 lados que podem ser
                modificados, sendo eles: superior, direito, inferior e 
                esquerdo.
            </p>
            <p>
                Para declarar os valores destas propriedades, temos duas 
                opções:
                <ul>
                    <li>
                        Forma longa: em que podemos declarar um por um dos 
                        lados
                    </li>
                    <li>
                        Forma resumida: em que podemos declarar mais de um por 
                        vez. Nesta opção, a ordem específica - superior, 
                        direito, inferior e esquerdo - é 
...
<div class="com-padding">
    Div com 10 pixels de padding. Note os espaço nas laterais internas do elemento.
            ...
            <ol>
                <li>
                    A forma resumida (ou short hand em inglês), na qual é 
                    possível declarar com apenas um valor a margem ou o 
...
img {
  padding: 10px 5px 20px 30px;
                ...
                <li>
                    Também é possível declarar apenas um lado por vez, caso 
                    queira dar valor apenas para um dos lados.
                    <div class="row-fluid">
                        <div class="span7 offset2">
                            <pre class="prettyprint linenums">
