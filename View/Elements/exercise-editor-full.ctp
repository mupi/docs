...
<div class="editEx <?php echo $exClass; ?>" data-lang="<?php echo $lang; ?>">
  <div class="mupi-exercise exercise">
    <div class="header row-fluid">
      <div class="query-title span12">
        <?php echo $exTitle; ?> 
      </div> 
    </div>
    <div class="body row-fluid">
      <div class="query editor editor-full span6"><?php echo $initialContent; ?></div> 
      <div class="span6">
  ...
  <div class="mupi-exercise-answer answer hide">
    ...
    <div class="body row-fluid">
      <div class="query editor editor-full span6"><?php echo $respContent; ?></div> 
